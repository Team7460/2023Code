...
public class ArmSubsystem extends SubsystemBase {
    ...
    public void setPivotMotorPositionSetpoint(double sp) {
        setpoint = MathUtil.clamp(sp, -mArmPivotMotor.getSoftLimit(CANSparkMax.SoftLimitDirection.kReverse), mArmPivotMotor.getSoftLimit(CANSparkMax.SoftLimitDirection.kForward));
